...
/* 
1. CREARE UN NUOVO DATABASE "Northwind"
2. COLLEGARSI A TALE DATABASE
3. COPIARE IL CODICE CONTENUTO NEL FILE ALL'INTERNO DEL QUERY TOOL
4. ESEGUIRE IL CODICE
5. PASSARE AL FILE "northwind_data.sql" E RIPETERE IL PROCESSO
*/
